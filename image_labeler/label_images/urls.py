...
urlpatterns = [
    ...
    path(
        ...
        views.select_primary_colors,
        name="select_primary_colors",
    ),
    ...
    # Review
    path(
        "view_mturk_responses/", views.view_mturk_responses, name="view_mturk_responses"
    ),
    ...
    path(
        "view_prediction_labels/",
        views.view_prediction_labels,
        name="view_prediction_labels",
    ),
    path("view_asset/", views.view_asset, name="view_asset"),
    path("view_label_issues/", views.view_label_issues, name="view_label_issues"),
    path(
        "correct_mismatch_labels/",
        views.correct_mismatch_labels,
        name="correct_mismatch_labels",
    ),
    # Admin
