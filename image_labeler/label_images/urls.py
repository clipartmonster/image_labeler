...
urlpatterns = [
    ...
    path('admin/labeler_labels/', views.admin_labeler_labels, name='admin_labeler_labels'),
    path('admin/labeler_labels/assignments/', views.admin_labeler_labels_assignments, name='admin_labeler_labels_assignments'),
